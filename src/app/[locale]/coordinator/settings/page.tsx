...
export default function CoordinatorSettingsPage() {
  ...
  const THEME_CARDS: { id: Theme; label: string; desc: string }[] = [
    { id: 'light', label: t('theme.light.label'), desc: t('theme.light.desc') },
    { id: 'dark',  label: t('theme.dark.label'),  desc: t('theme.dark.desc') },
    { id: 'auto',  label: t('theme.auto.label'),  desc: t('theme.auto.desc') },
  ]
  ...
  useEffect(() => {
    ...
    async function boot() {
      ...
      const dn = profile?.display_name || user.email || 'Coordinador'
      setUserName(dn)
  ...
  return (
    <>
      <style>{`
        ...
        .st-eyebrow{font-family:"Satoshi",sans-serif;font-size:11px;letter-spacing:.18em;color:var(--accent,#C0392B);text-transform:uppercase;font-weight:700;margin-bottom:10px;}
        ...
        .st-nav-btn.active{background:var(--accent,#C0392B);color:#fff;}
        ...
        .st-input:focus{border-color:var(--accent,#C0392B);}
        ...
        .st-textarea:focus{border-color:var(--accent,#C0392B);}
        .st-char{font-size:11px;color:var(--mute);text-align:right;margin-top:4px;}
        .st-badge{display:inline-flex;align-items:center;padding:4px 10px;border-radius:999px;font-size:11.5px;font-weight:600;background:rgba(192,57,43,.1);color:var(--accent,#C0392B);margin-right:6px;margin-bottom:6px;}
        .st-save-row{display:flex;justify-content:flex-end;margin-top:8px;}
        .btn-save{padding:11px 28px;border-radius:999px;background:var(--accent,#C0392B);color:#fff;border:none;font-family:"Satoshi",sans-serif;font-weight:700;font-size:14px;cursor:pointer;transition:background .2s;}
        ...
        .st-avatar{width:100px;height:100px;border-radius:50%;background:linear-gradient(135deg,var(--accent,#C0392B) 0%,#8B1A1A 100%);color:#fff;font-family:"Satoshi",sans-serif;font-weight:700;font-size:36px;display:flex;align-items:center;justify-content:center;overflow:hidden;cursor:pointer;position:relative;flex-shrink:0;}
        ...
        .theme-card.selected{border-color:var(--accent,#C0392B);box-shadow:0 0 0 3px rgba(192,57,43,.12);}
        ...
        .theme-check{position:absolute;top:10px;right:10px;width:20px;height:20px;border-radius:50%;background:var(--accent,#C0392B);display:flex;align-items:center;justify-content:center;}
        ...
        .toggle input:checked+.toggle-track{background:var(--accent,#C0392B);}
              ...
              {section === 'profile' && (
                <>
                  <div className="st-card">
                    ...
                    <div className="st-card-sub">{t('profileCard.coordinatorSubtitle')}</div>
                  ...
                  <div className="st-card">
                    ...
                    {pwSuccess ? (
                      ...
                      <form onSubmit={handleChangePassword}>
                        ...
                        {pwError && (
                          <div style={{ padding: '10px 14px', background: 'rgba(192,57,43,.08)', border: '1px solid rgba(192,57,43,.2)', borderRadius: 8, fontSize: 13, color: 'var(--accent,#C0392B)', marginBottom: 12 }}>
                            {pwError}
                          </div>
                        )}
                        <div className="st-save-row">
